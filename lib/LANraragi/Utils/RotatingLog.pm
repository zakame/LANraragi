...
# Runtime NFS guard: catches flock failures that slip past the is_supported() startup probe.
# (The probe uses a temp file; the actual lockfile may be on a different mount.)
